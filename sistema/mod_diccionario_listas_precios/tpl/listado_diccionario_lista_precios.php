  ...
  <div class="middle-content container-xxl p-0">
      ...
      <div class="page-meta">
          <nav class="breadcrumb-style-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Nombres de Lista de precios</a></li>
      ...
      <div class="row layout-top-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="row my-4">
                  ...
                  <div class="col-md-3">
                      <a href="#" onclick="ver_lista_precio();"  class="btn btn-primary">Nuevo nombre</a>
                  </div>
  ...
  <!-- MODAL  -->
  <div class="modal fade" id="nueva_lista_precio" tabindex="-1" role="dialog" aria-labelledby="nueva_lista_precio_label" aria-hidden="true">
     <!-- MODAL  -->
  ...
  <script>
      function cargar_tabla_lista_precios() {
          vtabla = $('#style-3').DataTable({
              ...
              "stripeClasses": [],
              'ajax': {
                  'url': '<?php echo ENLACE_WEB; ?>mod_diccionario_listas_precios/ajax/listado_diccionario_lista_precios_ajax.php',
                  'Method': 'POST'
              },
              retrieve: true,
              deferRender: true,
              ...
              'columns': [{
                      ...
                      render: function(data, type, row) {
                          ...
                          return `<a onclick="ver_lista_precio(${row.ID});" href="#">${row.ID}</a>`
                      }
                  },
                  {
                      data: 'etiqueta',
                      ...
                      render: function(data, type, row) {
                          return `<a onclick="ver_lista_precio(${row.ID});" href="#">${data}</a>`
                      }
  ...
  <script>
      $(document).ready(function() {
          ...
          cargar_tabla_lista_precios();
                  ...
                  //      $("#monedas_listado").addClass('active');
  ...
  <script type="text/javascript">
      ...
      function ver_lista_precio(int = null) {
          ...
          $.ajax({
              ...
              data: {
                  action: 'ver_lista_precio',
                  fiche: int,
              },
          }).done(function(html) {

              //print html en el modal cargado
              $("#nueva_lista_precio").html(html).modal('show');
          });

      }


      function actualizar_lista_precios(int) {
          ...
          $.ajax({
              ...
              data: {
                  action: 'actualizar_lista_precios',
                  etiqueta: label,
                  estado: $("#estado_lista").val(),
              ...
              if (mensaje.exito === 1) {
                  add_notification({
                      text: 'Nombres Lista precio actualizado exitosamente',
                      actionTextColor: '#fff',
                      backgroundColor: '#00ab55',
                      dismissText: 'Cerrar'
                  });
      ...
      function borrar_lista_precios($id) {
          // Preparar el mensaje para el snackbar
          var message = "Está seguro(a) que desea eliminar la lista? ";
          ...
          add_notification({
              ...
              onActionClick: function(element) {
                  ...
                  $.ajax({
                      ...
                      if (data.exito == 1) {
                          add_notification({
                              text: 'Nombres Lista precio Eliminado exitosamente',
                              pos: 'top-right',
                              actionTextColor: '#fff',
                              backgroundColor: '#00ab55'
                          });
...
document.getElementById('agregar_lista').disabled = true;
document.getElementById('borrar_lista').disabled = true;
...
function ocultar_snackbar() {
    $(".snackbar-container").fadeOut(500); // 500 milisegundos para la animación
         ...
         document.getElementById('agregar_lista').disabled = false;
    document.getElementById('borrar_lista').disabled = false;
}

// Escuchar el evento de ocultar el modal con id 'nueva_lista_precio'
document.getElementById('nueva_lista_precio').addEventListener('hidden.bs.modal', function () {
...
function aplicar_borrado($id){
     ...
     $.ajax({
                ...
                if (data.exito == 1) {
                    add_notification({
                        text: 'Nombre Eliminado exitosamente',
                        pos: 'top-right',
                        actionTextColor: '#fff',
                        backgroundColor: '#00ab55'
                    });
