...
// Consulta SQL para obtener las compras con todas las columnas de la imagen
$sql = "SELECT 
            a.rowid,
...
while ($data = $db->fetch(PDO::FETCH_OBJ)) {
    ...
    $tr .= '<tr class="ng-scope" style="cursor:pointer;">
            ...
            <td>
                <a href="' . ENLACE_WEB . 'compra/' . $data->rowid . '" target="_blank">
...
if ($tr == '') {
    echo '<tr><td colspan="10" style="text-align:center">No se han encontrado registros de compras</td></tr>';
} else {
