...
<div class="layout-px-spacing">
  ...
  <div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Retenciones </li>
      </ol>
    </nav>
  </div>
  <!-- /BREADCRUMB -->
  ...
  <form role="form" action="<?php echo ENLACE_WEB; ?>mod_reporte_2_descarga_documentos/json/descarga_documentos.json.php" method="POST">
...
<script>
  ...
  function cargarVistaPrevia() {
    ...
    $.ajax({
        method: "POST",
        url: "<?php echo ENLACE_WEB; ?>mod_reporte_2_descarga_documentos/json/descarga_documentos.json.php",
