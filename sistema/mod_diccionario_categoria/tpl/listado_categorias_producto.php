  ...
  <div class="middle-content container-xxl p-0">
      ...
      <div class="page-meta">
          <nav class="breadcrumb-style-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Categoría Producto</a></li>
      ...
      <div class="row layout-top-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="row my-4">
                  ...
                  <div class="col-md-3">
                      <a href="#" onclick="ver_categoria();" class="btn btn-primary">Nueva Categoría de producto</a>
                  </div>
  ...
  <script>
      function cargar_tabla_categoria_producto() {
          vtabla = $('#style-3').DataTable({
              ...
              "stripeClasses": [],
              'ajax': {
                  'url': '<?php echo ENLACE_WEB; ?>mod_diccionario_categoria/ajax/listado_categorias_producto_ajax.php',
                  'Method': 'POST'
              },
              retrieve: true,
              deferRender: true,
              ...
              'columns': [{
                      ...
                      render: function(data, type, row) {
                          tag_categoria = '';
                          if (row.fk_parent > 0) {
                              //  tag_categoria = '<span class="shadow-none badge badge-primary">Sub categoria</span>';
                          }

                          return `<a onclick="ver_categoria(${row.ID});" href="#">${data}</a> ${tag_categoria}`
...

                  {
                      ...
                      searchable: true,
                      createdCell: function(td, cellData, rowData, row, col) {
                          $(td).addClass('text-left').attr('data-label', 'sub_categoria');
                      },
                      render: function(data, type, row) {

                          return `<a onclick="ver_categoria(${row.ID});" href="#">${data}</a> `
  ...
  <script>
      $(document).ready(function() {
          ...
          cargar_tabla_categoria_producto();
          ...
          $("#categorias_producto_listado").addClass('active');
  ...
  <script type="text/javascript">
      function crear_diccionario_categoria(event) {
          ...
          $.ajax({
              ...
              if (mensaje.exito == 1) {
                  ...
                  add_notification({
                      text: 'Categoría Producto creado exitosamente',
                      actionTextColor: '#fff',
      ...
      function actualizar_diccionario_categoria(int) {
          ...
          $.ajax({
              ...
              data: {
                  action: 'actualizar_diccionario_categoria',
                  label: label,
                  fk_parent: $("#categoria_padre").val(),
              ...
              if (mensaje.exito === 1) {
                  add_notification({
                      text: 'Categoría Producto actualizado exitosamente',
                      actionTextColor: '#fff',
                      backgroundColor: '#00ab55',
                      dismissText: 'Cerrar'
                  });
      ...
      function confirma_eliminar($id) {
          ...
          document.getElementById('agregar_diccionario_categoria').disabled = true;
          document.getElementById('borrar_diccionario_categoria').disabled = true;
      ...
      function aplicar_borrado($id) {
          ...
          $.ajax({
              ...
              beforeSend: function(xhr) {},
              data: {
                  action: 'borrar_diccionario_categoria',
                  id: $id
              },
          }).done(function(msg) {
              console.log(msg);
              ...
              if (mensaje.exito == 1) {
                  add_notification({
                      text: 'Categoría Producto Eliminado exitosamente',
                      pos: 'top-right',
                      actionTextColor: '#fff',
                      backgroundColor: '#00ab55'
                  });

                  // habilitar los botones "agregar_diccionario_categoria" y "borrar_diccionario_categoria"
                  document.getElementById('agregar_diccionario_categoria').disabled = false;
                  document.getElementById('borrar_diccionario_categoria').disabled = false;
      ...
      document.getElementById('nueva_diccionario_categoria').addEventListener('hidden.bs.modal', function() {
