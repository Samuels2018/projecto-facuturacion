    ...
    <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="switch form-switch-custom switch-inline form-switch-primary">
                                <input class="switch-input" type="checkbox" role="switch" id="forma_importes_iguales" name="forma_importes_iguales" <?php echo ($obj->importes_iguales == 1) ? 'checked' : ''; ?> <?php echo $disabled; ?>>
                                <label class="switch-label" for="tosell">Importes iguales</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="switch form-switch-custom switch-inline form-switch-primary">
                                <input class="switch-input" type="checkbox" role="switch" id="forma_ultimo_dia" name="forma_ultimo_dia" <?php echo ($obj->ultimo_dia == 1) ? 'checked' : ''; ?> <?php echo $disabled; ?>>
        ...
        <div class="modal-footer">
            ...
            <?php if (empty($_REQUEST['fiche'])) { ?>
                <button type="button" class="btn btn-primary" id="agregar_forma_pago" onclick="estado_accion = 1; guardar_modal_forma_pago(event)"><i class="fa fa-fw fa-circle" aria-hidden="true"></i> Guardar</button>
            <?php } else { ?>
                <button type="button" class="btn btn-danger" id="borrar_forma_pago" onclick="estado_accion = 2; borrar_forma_pago(<?= $obj->id; ?>)"><i class="fa fa-fw fa-trash" aria-hidden="true"></i> Borrar</button>
                <button type="button" class="btn btn-primary" id="agregar_forma_pago" onclick="estado_accion = 1; guardar_modal_actualiza_formapago(<?= $obj->id; ?>)" ><i class="fa fa-fw fa-circle" aria-hidden="true"></i> Actualizar</button>
...
<script src="./mod_formas_pago/tpl/forma_pago_detail.js"></script>
<style> 
