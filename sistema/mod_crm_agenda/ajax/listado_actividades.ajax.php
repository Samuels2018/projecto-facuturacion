...
$consulta = "SELECT count(*) FROM oportunidad_actividades ca 
...
left join a_medida_cisma_cotizaciones_diccionario_crm_actividades_estado as de ON ca.fk_estado = de.rowid
where 1".$where;
