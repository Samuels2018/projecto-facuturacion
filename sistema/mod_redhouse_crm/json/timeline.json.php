...
if (isset($_GET['term'])) {
    ...
    FROM a_medida_redhouse_cotizaciones_cotizaciones_actividades  cpa 
    LEFT JOIN a_medida_cisma_cotizaciones_diccionario_crm_actividades  da ON da.rowid = cpa.fk_diccionario_actividad
    left join a_medida_cisma_cotizaciones_diccionario_crm_actividades_estado  de on de.rowid = cpa.fk_estado
    where cpa.fk_cotizacion = $term order by cpa.vencimiento_fecha ASC";
