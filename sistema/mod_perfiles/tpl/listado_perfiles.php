  ...
  <div class="middle-content container-xxl p-0">
      ...
      <div class="row layout-top-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="row my-4">
                  <div class="col-md-3">
                      <a href="<?=ENLACE_WEB?>perfil_crear/" class="btn btn-primary">Nuevo Perfil</a>
                  </div>
  ...
  <script>
      function cargar_tabla__crm_terceros() {
          vtabla = $('#style-3').DataTable({
              ...
              "stripeClasses": [],
              'ajax': {
                  'url': '<?php echo ENLACE_WEB; ?>mod_perfiles/ajax/listado.perfiles.ajax.php',
                  'Method': 'POST'
              },
              retrieve: true,
              deferRender: true,
              ...
              'columns': [{
                      ...
                      createdCell: function(td, cellData, rowData, row, col) {
                       ...
                       render: function(data, type, row) {
                          return `<a href="${ENLACE_WEB}/perfil_editar/${row.ID}">${row.ID}</a>`
                      }
                  },
                  {
                      data: 'Etiqueta',
                      ...
                      render: function(data, type, row) {
                          return `<a href="${ENLACE_WEB}/perfil_editar/${row.ID}">${data}</a>`
                      }
