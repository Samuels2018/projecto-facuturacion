...
<div class="middle-content container-xxl p-0">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo ENLACE_WEB; ?>perfiles_listado">Perfil</a></li>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input required="required" placeholder="Etiqueta" type="text" name="etiqueta" id="etiqueta" class="form-control" value="<?php echo $obj->etiqueta; ?>" <?php echo $disabled; ?>>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card-footer mt-12">
                                                    <?php
                                                    if (empty($_REQUEST['fiche'])) { ?>
                                                        <a href="<?php echo ENLACE_WEB; ?>perfiles_listado" class="btn btn-primary"><i class="fa fa-fw fa-circle"></i>Cancelar</a>
                                                        <button type="button" class="btn btn-primary" onclick="crearPerfil(event)"><i class="fa fa-fw fa-circle"></i>Crear Perfil </button>
                                                    <?php }

                                                    if (!empty($_REQUEST['fiche']) and $_GET['action'] !== "modificar") { ?>
                                                        <a href="<?php echo ENLACE_WEB; ?>perfiles_listado" class="btn btn-outline-primary">
                                                        ...
                                                        <?php 
                                                            if(intval($obj->borrado) === 0){
                                                        ?>

                                                        <a href="#" onclick="confirma_eliminar_perfil('<?php echo $_REQUEST['fiche']; ?>')" class="btn btn-danger  bs-tooltip " data-bs-placement="left" title="Tooltip on left"><i class="fa fa-fw fa-trash"></i> Desactivar </a>
                                                    ...
                                                    <?php } ?>
                                                       ...
                                                       <?php 
                                                            if(intval($obj->borrado) === 1){
                                                        ?>
                                                        <a href="#" onclick="confirma_activar_perfil('<?php echo $_REQUEST['fiche']; ?>')" class="btn btn-success"><i class="fa fa-fw fa-edit"></i> Activar</a>

                                                    <?php } else{ ?>
                                                        <a href="<?php echo ENLACE_WEB; ?>dashboard.php?accion=editar_perfil&action=modificar&fiche=<?php echo $_REQUEST['fiche']; ?>" class="btn btn-success"><i class="fa fa-fw fa-edit"></i> Modificar</a>
                                                    ...
                                                    <?php if ($_REQUEST['action'] == "modificar" and !empty($_REQUEST['fiche'])) { ?>
                                                        ...
                                                        <a href="<?php echo ENLACE_WEB; ?>dashboard.php?accion=perfil_editar&fiche=<?php echo $_REQUEST['fiche']; ?>" class="btn btn-outline-primary"><i class="fa fa-fw fa-circle"></i>Cancelar modificación de <?php echo $obj->tipo_texto; ?></a>



                                                        <button type="submit" name="editar" value="true" class="btn btn-primary" onclick="actualizarPerfil(event)">
...
<script type="text/javascript">
    ...
    function crearPerfil(event) {
        ...
        //    console.log("Actualizando");
            ...
            if (mensaje.exito ==1 ) {
                     ...
                     window.location.href = "<?php echo ENLACE_WEB; ?>perfiles_listado/";
            } else {
    ...
    function confirma_eliminar_perfil($id) {
        // Preparar el mensaje para el snackbar
        var message = "Está seguro(a) que desea eliminar el perfil? ";
     ...
     function confirma_activar_perfil($id) {
        // Preparar el mensaje para el snackbar
        var message = "Está seguro(a) que desea activar el perfil? ";
        var actionText = "Confirmar";
        ...
        add_notification({
            ...
            onActionClick: function(element)
            {
                ...
                $.ajax({
                    ...
                    if (data.exito == 1) {
                        add_notification({
                            text: 'Perfil Activado exitosamente',
                            pos: 'top-right',
                            actionTextColor: '#fff',
                            backgroundColor: '#00ab55'
                        });
