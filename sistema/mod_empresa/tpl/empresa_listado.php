  ...
  <div class="middle-content container-xxl p-0">
      ...
      <div class="row layout-top-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="row my-4">
                  <div class="col-md-3">
                      <a href="#" onclick="ver_modal()" class="btn btn-primary">Nueva empresa</a>
                  </div>
  ...
  <script>
      function cargar_tabla_crm() {
          vtabla = $('#style-3').DataTable({
              ...
              "stripeClasses": [],
              'ajax': {
                  'url': '<?php echo ENLACE_WEB; ?>mod_empresa/ajax/listado_empresa_ajax.php',
                  'Method': 'POST'
              },
              retrieve: true,
              deferRender: true,
...
<script type="text/javascript">
       ...
       function ver_modal(int = null) {
          ...
          $.ajax({
              method: "POST",
              url: "<?php echo ENLACE_WEB; ?>mod_empresa/tpl/modal_empresa.php",
    ...
    function crearEmpresa(event) {
        ...
        $('#nombre_empresa').removeClass("input_error");
     
        // Recoger los valores del formulario usando jQuery
        const nombre_empresa = $('#nombre_empresa').val();
   
        // Validar que los campos no estén vacíos y añadir la clase de error si es necesario
        if (nombre_empresa == '') { 
            $('#nombre_empresa').addClass("input_error"); 
            error = true;  
        }

        const estado_empresa = $("#estado_empresa").val();
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo ENLACE_WEB; ?>mod_empresa/class/clases.php",
            beforeSend: function(xhr) {
    ...
    function actualizarEmpresa(id) {
        ...
        if(estado_empresa == '')
        {
          $("#estado_empresa").addClass('input_error');
        }
    ...
    function confirma_eliminar($id) {
        ...
        var message = "Está seguro(a) que desea desactivar la empresa? ";
