...
$Lan->cargar_diccionario($_SESSION['idioma']);
$accion = $_GET['accion'];
...
if ($dbh->getAttribute(PDO::ATTR_ERRMODE) !== PDO::ERRMODE_WARNING) {
    // Generar un mensaje de advertencia
    echo "ADVERTENCIA: La configuración PDO::ERRMODE no está establecida en PDO::ERRMODE_WARNING. Esto puede causar problemas de manejo de errores.\n";
    exit(1);
}
...
<body class="layout-boxed dark" data-bs-spy="scroll" data-bs-target="#navSection" data-bs-offset="140">
    ...
    <div class="header-container container-fluid container-data">
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-item flex-row mr-2">
                <li class="nav-item text-center">
                    <a href="<?= ENLACE_WEB ?>nueva_factura" class="avatar avatar-sm text-primary">
                        <i class="fa fa-fw fa-plus-square"></i>
                        FACT
                    </a></li>
                <li class="nav-item text-center">
                    <a href="<?= ENLACE_WEB ?>nuevo_albaran" class="avatar avatar-sm text-warning">
                        <i class="fa fa-fw fa-plus-square"></i>
                        ALBA
                    </a></li>
                <li class="nav-item text-center">
                    <a href="<?= ENLACE_WEB ?>nuevo_pedido" class="avatar avatar-sm text-danger">
                        <i class="fa fa-fw fa-plus-square"></i>
                        PEDI
                    </a></li>
            </ul>
            ...
            <?php
            include_once ENLACE_SERVIDOR . "mod_tpl/tpl/buscador.php";
            ?>
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-tem mt-2 menu-flotante custom-menu-flotante">
                    ...
                    <?php
                    include_once ENLACE_SERVIDOR . "mod_tpl/tpl/menu_flotante.php";
                    ?>
                </li>

                <li class="nav-tem mt-2">
                    <a href="<?= ENLACE_WEB ?>mis_pendientes/1">
                        <i class="fa fa-calendar"></i>Tareas

                        <span class="badge badge-primary sidebar-label conteo"> </span>
                    </a>
                </li>

                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo ENLACE_WEB_FILES . $Lan->idiomas[$Lan->idioma]['flag']; ?>" class="flag-width" alt="flag">
                    </a>
                    ...
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar-container">
                            <div class="avatar avatar-sm avatar-indicators avatar-online">
                                <img alt="avatar" src="<?php echo $Usuarios->obtener_url_avatar_encriptada($_SESSION['usuario']); ?>" class="rounded-circle">
                            </div>
                        </div>
                    </a>
    ...
    <div class="main-container " id="container">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <?php include_once ENLACE_SERVIDOR . "mod_tpl/tpl/menu.inc.php"; ?>
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                include ENLACE_SERVIDOR . "mod_switch/tpl/switch.tpl.php";
                if ($tpl != "") {
                    require ENLACE_SERVIDOR . $tpl;
                }
            ...
            <div class="footer-wrapper">
                ...
                <div class="footer-section f-section-2">
                    ...
                    <a href="<?php echo ENLACE_WEB . "log_cambios" ?>">Ver Log de Cambios </a>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#selector_entidad").change(function() {
                ...
                entidad = $(this).val();
                entidad_nombre = $('#selector_entidad option:selected').text();
