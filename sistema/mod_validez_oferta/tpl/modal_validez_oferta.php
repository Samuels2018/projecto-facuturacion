...
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><?=$titulo?> Validez Oferta</h5>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input required="required" placeholder="Nombre Validez Oferta" type="text" name="label" id="label" class="form-control" value="<?php echo $obj->label; ?>" <?php echo $disabled; ?>>
                </div>

                <div class="col-md-6">
                    <label for="ref"><i class="fa fa-fw fa-asterisk"></i> Estado</label>
                    <select name="estado_validez_oferta" id="estado_validez_oferta" class="form-control">
