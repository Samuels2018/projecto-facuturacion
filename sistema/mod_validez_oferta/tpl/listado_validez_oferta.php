...
?>
  <div class="middle-content container-xxl p-0">
      ...
      <div class="page-meta">
          <nav class="breadcrumb-style-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Validez Oferta</a></li>
  ...
  <script>
      function cargar_tabla() {
        const ajaxoption = {
            url: '<?php echo ENLACE_WEB; ?>mod_validez_oferta/ajax/listado_validez_oferta_ajax.php',
            type: 'GET'
        }
        ...
        var newButton = $('<button>')
              .html('<i class="fas fa-plus"></i> Nuevo validez oferta')
  ...
  <script type="text/javascript">
      ...
      function guardar(event) {
          ...
          $.ajax({
              method: "POST",
              url: "<?php echo ENLACE_WEB; ?>mod_validez_oferta/ajax/validez_oferta_ajax.php",
              ...
              data: {
                  ...
                  label: label,
                  id:fiche,
                  estado: $("#estado_validez_oferta").val(),
              },
          }).done(function(msg) {
      ...
      function ver_informacion(int = null) {
          ...
          $.ajax({
              method: "POST",
              url: "<?php echo ENLACE_WEB; ?>mod_validez_oferta/tpl/modal_validez_oferta.php",
              beforeSend: function(xhr) {
