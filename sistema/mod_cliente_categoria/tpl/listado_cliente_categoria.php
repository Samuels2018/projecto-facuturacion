  ...
  <div class="middle-content container-xxl p-0">
      ...
      <div class="page-meta">
          <nav class="breadcrumb-style-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Categoría Cliente</a></li>
      ...
      <div class="row layout-top-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="row my-4">
                  ...
                  <div class="col-md-3">
                      <a href="#" onclick="ver_categoria_cliente();"  class="btn btn-primary">Nueva Categoría Cliente</a>
                  </div>
  ...
  <script>
      function cargar_tabla__crm_terceros() {
          vtabla = $('#style-3').DataTable({
              ...
              "stripeClasses": [],
              'ajax': {
                  'url': '<?php echo ENLACE_WEB; ?>mod_cliente_categoria/ajax/listado_cliente_categoria.ajax.php',
                  'Method': 'POST'
              },
              retrieve: true,
              deferRender: true,
              ...
              'columns': [
                  {
                      ...
                      render: function(data, type, row) {
                          return `<a onclick="ver_categoria_cliente(${row.ID});" href="#">${data}</a>`
                      }
  ...
  <script type="text/javascript">
      function crear_categoria_cliente(event) {
          ...
          $.ajax({
              method: "POST",
              url: "<?php echo ENLACE_WEB; ?>mod_cliente_categoria/ajax/cliente_categoria.ajax.php",
              beforeSend: function(xhr) {

              },
              data: {
                  action: 'crear_categoria_cliente',
                  label: label,
              },
          }).done(function(msg) {
              ...
              if (mensaje.exito == 1) {
                  ...
                  add_notification({
                      text: 'Categoría cliente creado exitosamente',
                      actionTextColor: '#fff',
      ...
      function ver_categoria_cliente(int = null) {

    
          // Preparar la petición AJAX
          $.ajax({
              method: "POST",
              url: "<?php echo ENLACE_WEB; ?>mod_cliente_categoria/tpl/modal_cliente_categoria.php",
              beforeSend: function(xhr) {
                  // aqui deberia ocurrir una carga
              },
              data: {
                  action: 'ver_categoria_cliente',
                  fiche: int,
              },
          }).done(function(html) {
      ...
      function actualizar_categoria_cliente(int) {
          ...
          $.ajax({
              ...
              data: {
                  action: 'actualizar_categoria_cliente',
                  label: label,
      ...
      function confirma_eliminar($id) {
            ...
            document.getElementById('actualizar_categoria_cliente').disabled = true;
            document.getElementById('borrar_categoria_cliente').disabled = true;

            // Preparar el mensaje para el snackbar
            var message = "Está seguro(a) que desea eliminar la categoría CRM?";
            var actionText = "<strong onclick='ocultar_snackbar();' id='cancelar_borrado'>Cancelar</strong> <button onclick='borrar_categoria_cliente("+$id+")' style='margin-left:5px;' id='confirmar_borrado' class='btn btn-danger'>Confirmar</button>";
        ...
        function ocultar_snackbar() {
            ...
            document.getElementById('actualizar_categoria_cliente').disabled = false;
            document.getElementById('borrar_categoria_cliente').disabled = false;
        }


        document.getElementById('nuevo_categoria').addEventListener('hidden.bs.modal', function () {
      ...
      function borrar_categoria_cliente($id) {
          // Preparar el mensaje para el snackbar
          var message = "Está seguro(a) que desea eliminar la categoría cliente? ";
          ...
          add_notification({
              ...
              onActionClick: function(element) {
                  ...
                  $.ajax({
                      ...
                      beforeSend: function(xhr) {},
                      data: {
                          action: 'borrar_categoria_cliente',
                          id: $id
                      },
                  }).done(function(msg) {
                      console.log(msg);
