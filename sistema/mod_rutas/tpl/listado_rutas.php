  ...
  <div class="middle-content container-xxl p-0">
      ...
      <div class="page-meta">
          <nav class="breadcrumb-style-one" aria-label="breadcrumb">
              <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Rutas</a></li>
      ...
      <div class="row layout-top-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="row my-4">
                  ...
                  <div class="col-md-3">
                      <a href="#" onclick="ver_rutas();"  class="btn btn-primary">Nueva Ruta</a>
                  </div>
  ...
  <!-- MODAL  -->
  <div class="modal fade" id="nueva_ruta" tabindex="-1" role="dialog" aria-labelledby="nueva_ruta_label" aria-hidden="true">
     <!-- MODAL  -->
  ...
  <script>
      function cargar_tabla_rutas() {
          vtabla = $('#style-3').DataTable({
              ...
              "stripeClasses": [],
              'ajax': {
                  'url': '<?php echo ENLACE_WEB; ?>mod_rutas/ajax/listado_rutas.ajax.php',
                  'Method': 'POST'
              },
              retrieve: true,
              deferRender: true,
              ...
              'columns': [
                  {
                      ...
                      render: function(data, type, row) {
                          return `<a  onclick="ver_rutas(${row.ID});" href="#">${row.label}</a>`
                      }
  ...
  <script>
      $(document).ready(function() {
        ...
        cargar_tabla_rutas();
                ...
                $("#crm_categorias").addClass('active');
...
<script type="text/javascript">
    function crear_ruta(event) {
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo ENLACE_WEB; ?>mod_rutas/ajax/rutas.ajax.php",
    ...
    function ver_rutas(int = null) {
        // Preparar la petición AJAX
        $.ajax({
            method: "POST",
            url: "<?php echo ENLACE_WEB; ?>mod_rutas/tpl/modal_rutas.php",
            beforeSend: function(xhr) {
            ...
            $("#nueva_ruta").html(html).modal('show');
        });
    }

    function actualizar_ruta(int) {
    ...
    function borrar_ruta($id) {
        ...
        document.getElementById('actualizar_ruta').disabled = true;
        document.getElementById('borrar_ruta').disabled = true;


        // Preparar el mensaje para el snackbar
        var message = "Está seguro(a) que desea eliminar la ruta?";
...
function ocultar_snackbar() {
    $(".snackbar-container").fadeOut(500); // 500 milisegundos para la animación
         ...
         document.getElementById('actualizar_ruta').disabled = false;
    document.getElementById('borrar_ruta').disabled = false;
}

document.getElementById('nueva_ruta').addEventListener('hidden.bs.modal', function () {
