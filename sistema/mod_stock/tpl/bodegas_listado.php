      ...
      <div class="row layout-top-spacing">
          ...
          <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
              <div class="row my-4">
                  ...
                  <div class="col-md-3">
                      <a href="#" onclick="ver_bodega();" class="btn btn-primary">Nuevo Almacén</a>
                  </div>
                          ...
                          <table id="style-3" class="table style-3 dt-table-hover">
                              <thead>
                                  <tr>
                                      ...
                                      <th style="width: 15%;" scope="col">Estado Bodega</th>
  ...
  <!-- MODAL  -->
  <div class="modal fade" id="nueva_bodega" tabindex="-1" role="dialog" aria-labelledby="nueva_bodega_label" aria-hidden="true">
      <!-- MODAL  -->
  ...
  <script>
      function cargar_tabla_bodega() {
          vtabla = $('#style-3').DataTable({
              ...
              "stripeClasses": [],
              'ajax': {
                  'url': '<?php echo ENLACE_WEB; ?>mod_stock/ajax/listado_bodegas_ajax.php',
                  'Method': 'POST'
              },
              retrieve: true,
              deferRender: true,
              ...
              'columns': [{
                      ...
                      render: function(data, type, row) {
                          return `<a onclick="ver_bodega(${row.ID});" href="#">${data}</a>`
                      }
...

                  {
                    ...
                    searchable: true,
                    createdCell: function(td, cellData, rowData, row, col) {
                        $(td).addClass('text-left').attr('data-label', 'descripcion');
                    },
                    render: function(data, type, row) {

                        return `
                            <span>
                                <a onclick="ver_bodega(${row.ID});" href="#">${data}</a>
                            </span>
                        `;
                    }
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                            <span>
                                <a onclick="ver_bodega(${row.ID});" href="#"> ${badge}</a>
                            </span>
                        `;
                    }
                },
  ...
  <script type="text/javascript">
    ...
    function guardar(event)
    {
        ...
        const estadoBodega = $("#estado_bodega").val();
        const bodegaDefecto = $("#bodega_defecto").is(':checked') ? 1 : 0;
        ...
        if (estadoBodega == '0' && bodegaDefecto == 1) {
            add_notification({
                text: 'No puedes seleccionar como defecto una bodega desactivada.',
                actionTextColor: '#fff',
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo ENLACE_WEB; ?>mod_stock/ajax/bodegas_ajax.php",
            ...
            data: {
                ...
                label: label,
                estado: estadoBodega,
                nota: $("#nota_bodega").val(),
                id:id,
                bodega_defecto: bodegaDefecto // Enviar 1 si está marcado, 0 si no
            },
        }).done(function(msg) {
            console.log(msg);
      ...
      function ver_bodega(int = null) {

          // Preparar la petición AJAX
          $.ajax({
              method: "POST",
              url: "<?php echo ENLACE_WEB; ?>mod_stock/tpl/modal_bodega.php",
              beforeSend: function(xhr) {
              ...
              $("#nueva_bodega").html(html).modal('show');
          });
      ...
      function borrar_bodega($id) {
          // Preparar el mensaje para el snackbar
          var message = "Está seguro(a) que desea eliminar la Almacén? ";
      ...
      function confirma_eliminar($id) {
          ...
          document.getElementById('agregar_bodega').disabled = true;
          document.getElementById('borrar_bodega').disabled = true;


          // Preparar el mensaje para el snackbar
          var message = "¿Está seguro(a) que desea eliminar el Almacén?";
      ...
      document.getElementById('nueva_bodega').addEventListener('hidden.bs.modal', function() {
