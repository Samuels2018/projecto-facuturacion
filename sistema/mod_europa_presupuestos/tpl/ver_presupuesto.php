...
$Documento = new Presupuesto($dbh, $_SESSION['Entidad']);
$id = $_GET['fiche'];

$tipo = $Documento->nombre_clase;

if ($_GET['accion'] == "validar_presupuesto" and $Documento->estado == 0) {
   $Documento->fetch($id);
...
if ($_GET['accion'] == "convertir_presupuesto") {
   $Documento->fetch($id);
}
   ...
   <div class="page-meta mb-4">
      <nav class="breadcrumb-style-one" aria-label="breadcrumb">
         <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo ENLACE_WEB; ?>presupuesto_listado"><?php echo $Documento->documento_txt['singular']; ?></a></li>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="form-group row">
                     <div class="col-sm-6">
                        <h3><a href="<?php echo ENLACE_WEB; ?>presupuesto/<?php echo $Documento->id; ?>"><span><?php echo $Documento->referencia; ?></span></a></h3>
                     </div>
                  </div>
                  <?php if ($Documento->estado == 0) { ?>
      ...
      <div class="row mt-3 zona_trabajo_factura ">
         ...
         <div class="row mt-5">
            <div class="col-xs-12">
               ...
               <?php } ?>  
               <?php if ($Documento->estado == 0) {   ?>  
                           <a href="#"  onclick="validar_presupuesto()"   class="btn btn-outline-primary _effect--ripple waves-effect">
...
<script>
   ...
   function abrir_email() {
      ...
      window.open('<?php echo ENLACE_WEB ?>mail_sys/mail/enviar_email.tpl.php?id=<?php echo $_REQUEST['fiche'] ?>&opcion=<?php echo $Documento->nombre_clase; ?>', 'Enviar Email presupuesto', opt);
   }
   ...
   function validar_presupuesto() {
      ...
      Swal.fire({
         ...
         if (result.isConfirmed) {
            window.location.href = "<?php echo ENLACE_WEB; ?>dashboard.php?&accion=validar_presupuesto&fiche=<?php echo $Documento->id; ?>&option_serie=" + codigo_serie_selected;
   ...
   function anular_documento() {
      ...
      Swal.fire({
         ...
         if (result.isConfirmed) {
            ...
            $.ajax({
                  method: "POST",
                  url: "<?php echo ENLACE_WEB; ?>mod_europa_presupuestos/class/presupuesto.class.json.php",
                  data: {
                     documento: '<?php echo $Documento->id; ?>',
                     motivo: 'ANULACIÓN: ' + encodeURIComponent(sanitizedData),
                     'accion': 'anular_presupuesto'
                  },
               ...
               .done(function(msg) {
                  ...
                  if (data.exito == 1) {
                     ...
                     window.location.href = '<?php echo ENLACE_WEB; ?>ver_presupuesto/<?php echo $Documento->id; ?>';
