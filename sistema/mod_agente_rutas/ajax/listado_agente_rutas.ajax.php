...
$sqlstr = "SELECT ag.nombre AS nombre_agente , dr.label AS nombre_ruta, a.*  
FROM diccionario_agente_rutas a, fi_agentes ag, diccionario_rutas dr 
WHERE a.fk_agente = ag.rowid AND a.fk_ruta = dr.rowid";
...
$sqlstr .= " AND a.borrado = 0 ORDER BY a.rowid ";
...
foreach ($Records as $row) {
    $data[] = array(
        "ID" => $row['rowid'],
        "fk_ruta" => $row['nombre_ruta'],
        "fk_agente" => $row['nombre_agente'],
