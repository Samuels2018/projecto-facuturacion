...
<div class="layout-px-spacing">
  ...
  <form role="form" action="<?php echo ENLACE_WEB; ?>mod_reporte_1_descarga_documentos/json/descarga_documentos.json.php" method="POST">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <br><small>Incluir informaci&oacute;n <span class="actor"></span> en el reporte</small>
                </div>
...
<script>
  ...
  function cargarVistaPrevia() {
    ...
    $.ajax({
        method: "POST",
        url: "<?php echo ENLACE_WEB; ?>mod_reporte_1_descarga_documentos/json/descarga_documentos.json.php",
