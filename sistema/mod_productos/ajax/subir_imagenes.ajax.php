...
$UploadDirectory = ENLACE_FILES_EMPRESAS . 'imagenes/entidad_' . $_SESSION['Entidad'] . '/productos/';
...
if (move_uploaded_file($_FILES['FileInput']['tmp_name'], $UploadDirectory . $NewFileName)) {
    ...
    $sql = "INSERT INTO fi_productos_imagenes (fk_producto, label, activo, descripcion, creado_fecha, creado_fk_usuario) VALUES (:fk_producto, :label, 1, :descripcion, NOW(), :creado_fk_usuario)";
    $st = $dbh->prepare($sql);
    $st->bindValue(':fk_producto', $_POST['producto'], PDO::PARAM_INT);
