  ...
  */
	...
	$.fn.roadmap = function (events, opts) {
		...
		var buildEvent = function (event, key) {
			...
			html = html.replace('####ROWID###', event.rowid);
			html = html.replace('####ROWID_A###', event.rowid);
			html = html.replace('####ROWID_AA###', event.rowid);
			html = html.replace('####CLASE###', event.fk_estado);
			html = html.replace('####ESTATUS###', event.fk_estado);
			html = html.replace('####FK_COTIZACION###', event.fk_cotizacion);
