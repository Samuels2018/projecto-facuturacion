var App = function() {
    ...
    var categoryScroll = {
        scrollCat: function() {
            let sidebarwrapperobject = document.querySelectorAll('.sidebar-wrapper li.active')
            if(sidebarwrapperobject && sidebarwrapperobject.length>0){
                var sidebarWrapper = sidebarwrapperobject[0];
