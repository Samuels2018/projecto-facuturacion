...
$Adjuntos->tipo_documento = $_REQUEST['tipo_documento'];
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <table class="table table-bordered">
            ...
            <tr>
                <th>#</th>
                <th><i class="fa fa-fw fa-paperclip"></i>Ficha de <?php echo $Adjuntos->tipo_documento; ?></th>
                <th><b> <?php echo $_REQUEST['fiche'];  ?> </b></th>
                <th>Acciones</th>
              </tr>
            </thead>
            <tbody>
              ...
              echo '<tr>
                <td data-label="#">' . $i . '</td>
                <td data-label="Ficha de Producto"><b><a href="' . ENLACE_WEB .'servir_adjuntos_cotizaciones?img=' . $_SESSION['Entidad'] . '/'.$_REQUEST["tipo_documento"].'/' . $img->label . '" download="'.$img->descripcion.'">' . $img->descripcion . '</a></b></td>
                ...
                if (in_array($extension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'webp'])) {
                    echo '<img style="width:100px" src="' . ENLACE_WEB .'servir_adjuntos_cotizaciones?img=' . $_SESSION['Entidad'] . '/'.$_REQUEST["tipo_documento"].'/' . $img->label . '">';
                } else {
