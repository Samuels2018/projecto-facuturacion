  ...
  <div class="page-meta">
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"> IVA Soportado </li>
      </ol>
    </nav>
  </div>
  <!-- /BREADCRUMB -->
...
<script type="text/javascript">
  ...
  function cargarGrilla(column, value, mes, category) {
    const ajaxoption = {
      url: '<?php echo ENLACE_WEB; ?>mod_reporte_5_descarga_documentos/ajax/detalle.ajax.php',
      type: 'POST',
      data: {
        column: column,
        value: value,
  ...
  function drawChart() {
    ...
    var options = {
      ...
      colors: [ '<?php echo $Reporte->color_soportado; ?>' ]
