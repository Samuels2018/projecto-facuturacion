...
//  Objeto 
//
require_once ENLACE_SERVIDOR . 'mod_europa_albaran_venta/object/Albaran_venta.object.php';
...
$Documento2  = new Albaran_venta($dbh, $_SESSION['Entidad']);
if($document_id!=''){
...
while ($obj = $db->fetch(PDO::FETCH_ASSOC)) {
    ...
    if ($Documento2->estado != '0')  { $eliminar = ""; $editar ='';}
