...
if (!empty($_POST['action'])):
    ...
    switch ($_POST['action']):
        ...
        case 'actualizar_categoria_crm':
            ...
            $result = $obj->actualizar_categoria_crm();
        ...
        case 'crear_categoria_crm':
            ...
            $result = $obj->crear_categoria_crm();
            echo json_encode($result);
            break;

        case 'borrar_categoria_crm':
            $obj->entidad = $_SESSION['Entidad'];
            $obj->borrado_fk_usuario = $_SESSION['usuario'];
            $result = $obj->borrar_categoria_crm($_POST['id']);
            echo json_encode($result);
            break;
