-- --------------------------------------------------------
-- Host:                         64.23.179.230
-- Versión del servidor:         8.0.33-0ubuntu0.22.04.4 - (Ubuntu)
...
-- Volcando estructura para tabla licencias.diccionario_empresas_estados
CREATE TABLE IF NOT EXISTS `diccionario_empresas_estados` (
  ...
  PRIMARY KEY (`rowid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Diccionario de tipos de estados en la empresa';

-- Volcando datos para la tabla licencias.diccionario_empresas_estados: ~0 rows (aproximadamente)
INSERT INTO `diccionario_empresas_estados` (`rowid`, `etiqueta`, `color`, `clase`) VALUES
	(1, 'Activo', NULL, 'success');

-- Volcando estructura para tabla licencias.diccionario_usuarios_estado
...
-- Volcando datos para la tabla licencias.diccionario_usuarios_estado: ~0 rows (aproximadamente)
INSERT INTO `diccionario_usuarios_estado` (`rowid`, `etiqueta`, `logeable`) VALUES
	(1, 'Activo', 1);

-- Volcando estructura para tabla licencias.diccionario_usuario_tipos
CREATE TABLE IF NOT EXISTS `diccionario_usuario_tipos` (
  `rowid` int DEFAULT NULL,
  `etiqueta` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Tipos de usuarios de la plataforma\r\n';

-- Volcando datos para la tabla licencias.diccionario_usuario_tipos: ~2 rows (aproximadamente)
INSERT INTO `diccionario_usuario_tipos` (`rowid`, `etiqueta`) VALUES
	(1, 'Usuario'),
	(2, 'Gestoria'),
	(3, 'Revendedor');

-- Volcando estructura para tabla licencias.errores
...
-- Volcando datos para la tabla licencias.errores: ~0 rows (aproximadamente)

-- Volcando estructura para tabla licencias.sistema_empresa
CREATE TABLE IF NOT EXISTS `sistema_empresa` (
  ...
  `telefono_fijo` char(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telefono_movil` char(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `company_externo` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Volcando datos para la tabla licencias.sistema_empresa: ~6 rows (aproximadamente)
INSERT INTO `sistema_empresa` (`rowid`, `nombre`, `nombre_comercial`, `direccion_fk_provincia`, `direccion_fk_municipio`, `telefono_fijo`, `telefono_movil`, `website`, `fk_estado`, `creado_fecha`, `creado_fk_usuario`, `borrado`, `borrado_fecha`, `borrado_fk_usuario`, `fk_sistema_empresa_licencias`, `company_externo`, `avatar`) VALUES
	(1, 'Tech Solutions S.A. DEV', 'Tech Solutions S.A.', 44, NULL, '88493002', '88493002', NULL, 1, '2024-02-09 11:36:49', 1, 0, NULL, NULL, 1, '9341452376515315', '1.png'),
	(2, 'Cisma', 'cismacr.com', 1, 2, '923136587', '630167488', NULL, 1, '2024-02-09 11:36:49', 1, 0, NULL, NULL, 1, '', ''),
	(3, 'Project Master', 'Project Master', 1, 2, '923136587', '630167488', NULL, 1, '2024-02-09 11:36:49', 1, 0, NULL, NULL, 1, '9341452376515315', '3.png'),
	(4, 'Avantec.DS España', 'Avantec.DSE', 41, NULL, '04145761734', '630167488', NULL, 1, '2024-02-09 11:36:49', 1, 0, NULL, NULL, 1, '', '4.png'),
	(5, 'Red House', 'REd House ', 16, 113, '923136587', '630167488', NULL, 1, '2024-02-09 11:36:49', 1, 0, NULL, NULL, 1, '', '5.png'),
	(8, 'Nombre de la empresa', 'Nombre Comercial', 1, 2, '12345', '6788910', NULL, 1, '2024-07-24 08:59:04', 1, 0, NULL, NULL, 1, '1', '');

-- Volcando estructura para tabla licencias.sistema_empresa_licencias
CREATE TABLE IF NOT EXISTS `sistema_empresa_licencias` (
  ...
  `bd` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `server` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Volcando datos para la tabla licencias.sistema_empresa_licencias: ~1 rows (aproximadamente)
...
-- Volcando estructura para tabla licencias.sistema_empresa_usuarios
...
-- Volcando datos para la tabla licencias.sistema_empresa_usuarios: ~24 rows (aproximadamente)
...
-- Volcando estructura para tabla licencias.usuarios
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `acceso_clave` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `acceso_correo_estado` set('pendiente','validado') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendiente',
  ...
  `usuario_avatar` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usuario_telefono` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Es para notificaciones',
  `fk_estado` int DEFAULT NULL,
  `fk_idioma` int DEFAULT NULL COMMENT 'Apunta al idioma',
  `fk_provincia` int DEFAULT NULL,
  `correo_temporal` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`rowid`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Listado de Usuarios';

-- Volcando datos para la tabla licencias.usuarios: ~33 rows (aproximadamente)
