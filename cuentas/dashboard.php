...
if ($_SESSION['usuario_cuentas'] == NULL) {
...
$datos_empresa = $Empresa->fetch($_SESSION['usuario_cuentas']);
...
<head>
    ...
    <link href="<?php echo ENLACE_WEB; ?>bootstrap/assets/css/light/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
...
<body class="layout-boxed dark" data-bs-spy="scroll" data-bs-target="#navSection" data-bs-offset="140">
    ...
    <div class="header-container container-fluid container-data">
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <?php 
                include_once ENLACE_SERVIDOR_CUENTAS . "mod_tpl/tpl/buscador.php";
        ?>
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
              <!--  
                <li class="nav-tem mt-2 menu-flotante custom-menu-flotante">
                    ...
                    <?php
                        //include_once ENLACE_SERVIDOR_CUENTAS . "mod_tpl/tpl/menu_flotante.php";
                    ?>
                </li>-->
                        ...
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                ...
                                <div class="media-body">
                                    <h5><?php echo $datos_empresa['nombre']; ?></h5>
                                    <p><?php echo ($datos_empresa['nombre']); ?></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="main-container " id="container">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <?php require_once ENLACE_SERVIDOR_CUENTAS. "mod_tpl/tpl/menu.inc.php"; ?>
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                include ENLACE_SERVIDOR_CUENTAS . "mod_switch/tpl/switch.tpl.php";
                if ($tpl != "") {
                   require ENLACE_SERVIDOR_CUENTAS . $tpl;
                }
    ...
    <script src="<?php echo ENLACE_WEB ?>bootstrap/funciones_custom.js"></script>
    <!-- configuracion custom datable -->
    <script src="<?php echo ENLACE_WEB ?>bootstrap/config_datatable_custom.js"></script>
    <script src="<?php echo ENLACE_WEB ?>bootstrap/assets/js/scrollspyNav.js"></script>
